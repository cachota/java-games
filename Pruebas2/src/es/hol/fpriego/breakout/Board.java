...
public class Board extends JPanel implements Commons {
    ...
    // The ScheduleTask is triggerd every 10 ms. In the run method, we move the ball and the paddle. 
    // We check for possible collisiont. And we repaint the screen
    ...
    public void checkCollision() {
        ...
        //  We check how many bricks are destroyed. If we destroyed all 30 bricks, we win the game. S
