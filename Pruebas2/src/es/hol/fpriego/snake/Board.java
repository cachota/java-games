...
public class Board extends JPanel implements ActionListener {
	...
	// The B_WIDTH and B_HEIGHT constants determine the size of the board. The DOT_SIZE is the size of the apple 
	// and the dot of the snake. The ALL_DOTS constant defines the maximum number of possible dots on the board 
	// (900 = (300*300)/(10*10)). The RAND_POS constant is used to calculate a random position for an apple. 
    ...
    private void checkApple() {
    	...
    	// In the move() method we have the key algorithm of the game. To understand it, look at how the snake 
    	// is moving. We control the head of the snake. We can change its direction with the cursor keys. 
    	// The rest of the joints move one position up the chain. The second joint moves where the first was, 
