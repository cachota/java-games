...
public class Board extends JPanel implements Runnable, Commons { 
    ...
    private final String alienpix = "alien2.png";
    ...
    public void gameInit() {
        ...
        // We put 6px space among the aliens. We also create the player and the shot objects
    ...
    public void animationCycle()  {
        ...
        if (shot.isVisible()) {
            ...
            while (it.hasNext()) {
                ...
                // More precisely, the dying flag is set. We use it to display an explosion. 
        ...
        // destroyed. Eg. it must be visible. The bomb's destroyed flag must be set. In other words, 
        // it is alien's first bomb dropping or previous dropped bomb already hit the ground. 
        ...
        while (i3.hasNext()) {
            ...
            // If the bomb is not destroyed, it goes one px to the ground. If it hits the bottom, the destroyed flag is set. 
